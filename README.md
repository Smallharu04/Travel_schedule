...
<details>
  <summary><strong>1. 강의 매매</strong></summary>
...
<details>
  <summary><strong>2. 신뢰성 없는 강의 평가</strong></summary>
...
1. 강의 매매 
   ...
   <details>  매년 수강 신청 기간 반복되는 강의 매매는 전공 필수, 비대면 등 수요가 높은 강의를 먼저 선점해 현금 또는 온라인 상품권 등을 받고 학생들에게 판매하는 방식으로 이뤄지고 있습니다.  현재 보편적인 수강 신청 시스템들은 정원이 차면 수강 변경 기간에 여석이 생기는 즉시 재 신청할 수 있는 구조입니다.  하지만 이 시스템은 수강 신청 변경 기간 중 특정 시각에 A가 취소하고 B가 즉시 재 신청하는 방식의 사전 합의가 가능해, 정당한 대기자 보다 거래 참여자가 우선적으로 접근할 수 있는 불공정이 발생합니다. 이는 학생들에게 반복 접속/대기라는 시간 비용을 전가하고, 학습권을 침해하는 문제점이 있습니다. <summary>
    
2. 신뢰성 없는 강의 평가 
    
<details>  강의 평가는 학교 자체 플랫폼에서는 확인할 수 없고, 학생들이 많이 사용하는 커뮤니티 서비스를 통해  강의 평가를 확인할 수 있습니다. 그러나 커뮤니티 서비스에서는 별도의 수강 인증이 없어 수강하지 않은 강의들도  평가를 작성할 수 있습니다. 이는 사용자가 강의를 고려할 때 신뢰성이 없는 정보를 바탕으로 정할 수 있는 문제점이 있습니다. <summary>
