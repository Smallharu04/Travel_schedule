...
### <p> 특징 : 에브리타임은 편리한 시간표 제작, 대학교 커뮤니티, 대학 관련 정보 공유를 목적으로 제작된 온라인 서비스로 대한민국 대학 관련 사설 커뮤니티 1위 앱으로 현재 대한민국 2년제 및 4년제 대학교에 한해 서비스를 지원 </p>
### <p> 장점 : 강의평 및 수강편람 등의 정보에 대한 접근성 높음, 학생들이 과목과 교수에 대한 평가를 자유롭게 게시 가능, 수강하는 강의의 시간표를 입력하여 개인 일정을 등록 가능 </p>
### <p> 단점 : 실제 수강한 사람이 아니더라도 강의 평가 작성 가능 </p>

<img width="755" height="173" alt="thumb" src="https://github.com/user-attachments/assets/1837daf7-d3b1-4a82-aa6a-8a4e182d90ae" />
### 특징 : 고려대학교의 강의평가 및 필기 공유 사이트, 고려대의 재학생 및 졸업생이 만든 사이트. 강의 평가를 작성하는 등 다양한 활동을 통해 포인트를 얻고 강의 평가 열람 시 포인트를 사용할 수 있는 구조 
### 장점 : 수많은 학생들의 후기를 통해 각 세분화된 강의의 평점, 교수님의 스타일, 학습 내용의 유용성 등을 파악 가능. 강의평가 작성 시 포인트를 제공하여, 많은 사용자들이 강의에 대한 경험과 정보를 공유하도록 유도.
### 단점 : 실제 수강한 사람이 아니더라도 강의 평가 작성 가능 
